...
const PDF_REPORT_TYPES = [
  ...
  { key:'overview', icon:'📊', title:'รายงานสรุปภาพรวมยุทธศาสตร์', desc:'สรุปผลการดำเนินงานรายยุทธศาสตร์ทั้ง 4 ด้าน และงบบริหารสำนักงาน · งบประมาณ · สถานะโครงการ · ตารางสรุปรวม' },
